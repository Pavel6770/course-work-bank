...
def sample_category(sample_product):
    return Category("Электроника", "Смартфоны, ноутбуки, планшеты", [sample_product])
...
def test_category_initialization(sample_category, sample_product):
    ...
    assert sample_category.description == "Смартфоны, ноутбуки, планшеты"
...
def test_category_counters():
    ...
    cat2 = Category("Cat2", "desc2", [p2, p1])
