...
def spending_by_category(
    ...
    logger.info(f"Анализ трат по категории '{category}' за период {start_date.strftime('%d.%m.%Y')} - {end_date.strftime('%d.%m.%Y')}")
...
def spending_by_weekday(
    ...
    logger.info(f"Анализ средних трат по дням недели за период {start_date.strftime('%d.%m.%Y')} - {end_date.strftime('%d.%m.%Y')}")
...
def spending_by_workday(
    ...
    logger.info(f"Анализ трат в рабочие/выходные дни за период {start_date.strftime('%d.%m.%Y')} - {end_date.strftime('%d.%m.%Y')}")
