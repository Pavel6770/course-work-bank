...
def generate_report(
    ...
    return {
        ...
        "transactions": [
            {"date": t["date"], "amount": abs(t["amount"]), "category": t["category"], "description": t["description"]}
...
if __name__ == "__main__":
    ...
    currency_rates = [{"currency": "USD", "rate": 92.50}, {"currency": "EUR", "rate": 100.20}]

    stock_prices = [{"stock": "SBER", "price": 320.50}, {"stock": "GAZP", "price": 180.30}]
